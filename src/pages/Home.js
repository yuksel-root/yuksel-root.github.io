    ...
    <section className="home" id="home">
      ...
      <div className="home__container bd-grid">
        <div className="home__data">
          ...
          <div> <i className="fa fa-github-square" aria-hidden="true" /></div>
          <h1 className="home__title">Yüksel Can Şimşek</h1>
          <span className="home__profession">Developer</span>
         
          <div className="home__social">
            <a href="https://github.com/yuksel-root" className="home__social-link">
    ...
    <section className="home" id="home">
      ...
      <div className="home__container bd-grid">
        <div className="home__data">
          ...
          <div className="home__social">
            <a href="https://github.com/yuksi-root" className="home__social-link">
             <i className="bx bxl-github"></i>
            </a>
