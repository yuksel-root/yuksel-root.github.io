      ...
      <div className="works__container bd-grid">
        <div className="works__item">
          ...
          <div className="works__data">
            <a
              href="https://github.com/yuksi-root/Parking-App"
        ...
        <div className="works__item">
          ...
          <div className="works__data">
            <a
              href="https://github.com/yuksi-root/EnglishWord"
              className="works__link"
            >
              <i className="bx bx-link"></i>
            </a>
        ...
        <div className="works__item">
          ...
          <div className="works__data">
            <a
              href="https://github.com/yuksi-root/english-notebook-redux"
              className="works__link"
            >
              <i className="bx bx-link"></i>
            </a>
        ...
        <div className="works__item">
          ...
          <div className="works__data">
            <a
              href="https://github.com/yuksi-root/LaboratuvarAnalizTakip"
              className="works__link"
            >
              <i className="bx bx-link"></i>
            </a>
        ...
        <div className="works__item">
          ...
          <div className="works__data">
            <a
              href="https://github.com/yuksi-root/BirdGame"
              className="works__link"
            >
              <i className="bx bx-link"></i>
            </a>
        ...
        <div className="works__item">
          ...
          <div className="works__data">
            <a
              href="https://github.com/yuksi-root/flutter_news_app"
              className="works__link"
            >
              <i className="bx bx-link"></i>
            </a>
            <span className="works__title">Flutter News Android App</span>
          </div>
        </div>
      </div>
    </section>
